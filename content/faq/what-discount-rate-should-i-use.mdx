...
[DCF valuation explained](/guides/dcf-valuation-explained) has the worked example; [common valuation mistakes](/guides/common-valuation-mistakes) covers forecasts built backwards from a desired answer.
