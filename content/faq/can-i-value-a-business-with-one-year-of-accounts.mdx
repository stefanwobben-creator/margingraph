...
[How to value a business](/guides/how-to-value-a-business) covers the method; [common valuation mistakes](/guides/common-valuation-mistakes) covers the one-good-year problem, which is the same issue from the other direction.
