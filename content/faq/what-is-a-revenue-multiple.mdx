...
[Revenue multiple explained](/guides/revenue-multiple-explained) has the ranges by model; [revenue multiple or EBITDA multiple](/guides/revenue-multiple-or-ebitda-multiple) has a four-question test for choosing.
