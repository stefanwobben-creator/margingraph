...
Revenue growth with flat or falling margin is usually read as buying business rather than winning it, which is consistent with GF Data requiring both conditions before it counts a business as an above-average performer. [How profitability affects valuation](/guides/how-profitability-affects-valuation) covers why the two have to move together.
