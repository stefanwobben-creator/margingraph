...
The figure used in valuation is almost always *adjusted* or *normalised* EBITDA — restated for owner compensation at market rate, genuine one-off costs and non-operating items. Which adjustments a buyer accepts is where most of the negotiation happens, and [how EBITDA affects your valuation](/guides/how-ebitda-affects-your-valuation) covers the ones that survive.

If your business is small enough that one owner works in it full time, the relevant figure may be SDE rather than EBITDA — see [SDE vs EBITDA](/guides/sde-vs-ebitda).
