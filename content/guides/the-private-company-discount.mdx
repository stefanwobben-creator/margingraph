...
related:
  ...
  - guides/the-company-specific-risk-premium
...
**Do not accept it twice.** If your comparables are already private company transactions, and [most published SME multiples are](/guides/where-sme-multiples-come-from), the discount is already inside them. Applying a marketability discount on top of a private company multiple double-counts, and it is a common enough error to be worth checking for explicitly.
