...
Do this calculation before you quote a revenue multiple to anyone. If the implied EBITDA multiple is outside the range in [EBITDA multiple explained](/guides/ebitda-multiple-explained), the revenue multiple is wrong, not the EBITDA one.
...
<Warning title="What to do instead">
  ...
  <a href="/guides/how-profitability-affects-valuation">how profitability affects valuation</a>.
</Warning>
...
[Revenue multiple or EBITDA multiple](/guides/revenue-multiple-or-ebitda-multiple) works through the choice itself, with a four-question test.
