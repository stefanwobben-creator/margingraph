...
Getting this wrong is the most common error in the whole exercise, because SDE and EBITDA differ by the entire owner's salary and the multiples applied to them are not interchangeable. [SDE vs EBITDA](/guides/sde-vs-ebitda) covers the choice.
...
The multiple method is where most SME transactions actually land. [EBITDA multiple explained](/guides/ebitda-multiple-explained) covers what sets yours; [DCF valuation explained](/guides/dcf-valuation-explained) covers when discounting is worth the effort.
...
[Common valuation mistakes](/guides/common-valuation-mistakes) covers what usually goes wrong from here, and [what buyers look for](/guides/what-buyers-look-for) covers how the other side reads the same file.
