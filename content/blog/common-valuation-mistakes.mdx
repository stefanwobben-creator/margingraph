...
If revenue falls when you take three months off, the buyer is purchasing a job. This is not a small adjustment — it is routinely a full turn on the multiple, and sometimes it removes half the buyer pool entirely.
