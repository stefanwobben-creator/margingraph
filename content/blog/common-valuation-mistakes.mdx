...
**The check:** if your earnings figure includes your own salary, you are holding SDE and the multiple is 2–3.5×. [SDE vs EBITDA](/blog/sde-vs-ebitda) covers which one applies.
...
If revenue falls when you take three months off, the buyer is purchasing a job. Nobody has published an estimate of what that costs on price, but the more concrete effect is that funds and most strategic buyers will not bid at all, which removes them before a number is discussed. [Owner dependence: strong logic, no price data](/blog/owner-dependence-and-what-it-costs) sets out the evidence.

**The check:** name who owns each of your top five customer relationships. If the answer is you, five times, that is the finding. [Preparing your business for sale](/blog/preparing-your-business-for-sale) covers what to do about it.
