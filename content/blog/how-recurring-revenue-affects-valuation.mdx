...
faq:
  - question: How much does recurring revenue increase valuation?
    answer: Moving from mostly project revenue to mostly contracted revenue typically adds one to two turns to the multiple — on a business earning €500,000, roughly €500,000 to €1,000,000 of value. The effect is largest between 40% and 70% recurring.
...
<Metrics
  items={[
    ...
    { label: "40–70% recurring", value: "+1 to 2 turns", note: "where the curve is steepest" },
