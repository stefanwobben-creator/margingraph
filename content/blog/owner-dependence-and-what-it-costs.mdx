...
Owner dependence is the risk every buyer asks about and nobody can price. Ask what it costs and you will be told a full turn, or ten to twenty-five percent, or that it removes half the buyer pool.

We could not find a published estimate of any of those. What we did find is better, because it answers a question the discount was only ever standing in for.

## The natural experiment

The problem with measuring whether a CEO matters is obvious: good businesses attract good leaders, so any correlation is uninformative. In 2020, Bennedsen, Pérez-González and Wolfenzon published a study in the *Journal of Finance* that got around it in an unpleasant but rigorous way. They used **CEO hospitalisations** as a source of variation that the business did not choose.
...
Three findings from the paper that matter for a business owner thinking about selling.
...
Those are all ways of saying the same thing: the buyer is not willing to pay today for performance that depends on you being there tomorrow. Reducing dependence before the process starts is what turns that conversation into a price conversation.
