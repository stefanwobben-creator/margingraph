...
There is a number that gets applied to almost every private business valuation, usually without argument. Your business is not listed, so a discount comes off. Twenty percent, thirty, sometimes more.

The number has a genuine literature behind it. What that literature actually says is more interesting than the number, and considerably less settled.
...
**Controlled studies find much less.** Once you control for firm characteristics, the marketability component shrinks sharply. Bajaj and colleagues attributed 7.23% to marketability itself. Wruck, comparing restricted with registered private placements, isolated a 10.4% median. Against the 30% to 35% that the older uncontrolled studies report, that is a different claim.
...
**And the strongest paper finds nothing.** In 2019, Jaffe, Jindra, Pedersen and Voetmann published in the *Journal of Financial and Quantitative Analysis*. Their abstract is worth reading twice:

<Quote cite="Jaffe, Jindra, Pedersen and Voetmann, Journal of Financial and Quantitative Analysis, 2019">
